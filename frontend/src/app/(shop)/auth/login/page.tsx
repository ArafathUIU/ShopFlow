      ...
      <div className="max-w-md mx-auto">
        <div className="rounded-2xl border border-slate-200 bg-white shadow-xl shadow-slate-200/50 p-8 md:p-10">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500 mt-2">Sign in to your ShopFlow account</p>
          </div>
          ...
          <p className="text-center text-sm text-slate-500 mt-6">
            ...
            <Link href="/auth/register" className="text-indigo-600 font-medium hover:text-indigo-700 hover:underline">
              Register
            </Link>
          </p>
        </div>
